...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Milly", "milly@gmail.com", new DateTime(2004, 2, 19), 5000.99, d3);
            Seller s3 = new Seller(3, "Daniel Radcliffe", "bob@gmail.com", new DateTime(1989, 7, 23), 6000.0, d4);
            Seller s4 = new Seller(5, "Judi Dench", "judi@gmail.com", new DateTime(1934, 12, 9), 10000.0, d2);
            Seller s5 = new Seller(6, "Tilda Swinton", "tilda@gmail.com", new DateTime(1960, 11, 5), 8000.0, d3);
            Seller s6 = new Seller(7, "Tom Holland", "tom@gmail.com", new DateTime(1996, 7, 1), 11000.0, d2);
